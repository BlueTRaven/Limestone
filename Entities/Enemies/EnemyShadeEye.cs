...
namespace Limestone.Entities.Enemies
{
    public class EnemyShadeEye : Enemy
    {
        ...
        public EnemyShadeEye(Vector2 position, bool rotating, float angle = 0) : base(position)
        {
        ...
        private void SetDefaults()
        {
            ...
            frameConfiguration = new FrameConfiguration(FrameConfiguration.FrameActionPresetactive1inactive2, this,
                ...
                new Frame(15, new Rectangle(0, 0, 16, 16)),
                new Frame(15, new Rectangle(16, 0, 16, 16))),
        ...
        public override void Update(World world)
        {
            ...
            else
            {
                ...
                Vector2 moveDirec = Vector2.Normalize((startPosition + pos) - center);
                Move(moveDirec, 2);
            }
            ...
            if (shot0 <= 0)
            {
                ...
                Projectile p = new Projectile(Assets.GetTexFromSource("projectilesFull", 0, 0), new Color(95, 50, 50), 6, center, Vector2.Zero, new Vector2(12, 32), rotToPlayer, 45, 4, 512, 250);
            ...
            if (shot1 <= 0)
            {
                ...
                {
                    Projectile p = new Projectile(Assets.GetTexFromSource("projectilesFull", 9, 1), Color.White, 4, center, Vector2.Zero, new Vector2(16), i, 0, 1, 1024, 200);
                    world.CreateProjectile(p);
                }
